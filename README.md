...
`R` and `R Studio (version 4.1.2)` are installed, you will need to check for and install certain packages used in the analysis by running the code below:
...
Note: The next step for contributors to this project would be to submit a pull request for any changes to be merged with my original repository. However, I will not be accepting pull requests at this time. This may change in future, but in the meantime, please just email to chat about the project. 

## License

The project is licensed under the [`CC-BY-NC-4.O`](./LICENSE-CC-BY-NC-4.O). You can read about the conditions of this licence [here](https://creativecommons.org/licenses/by-nc/4.0/).

## Acknowledgments

The project would not have been possible without [Dr Peter Lugtig](https://www.peterlugtig.com/), [Dr Bella Struminskaya](https://www.uu.nl/staff/BStruminskaya), and their team of survey-coders. I am grateful for their patience and supervision over the several months. 


## Contact

This repository is maintained by Shannon Dickson. If you have any questions please feel free to contact me via email:
